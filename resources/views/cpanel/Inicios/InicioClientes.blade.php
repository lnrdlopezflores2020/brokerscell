...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-5 border-bottom pb-4 gap-3">
            ...
            <div>
                <a href="https://wa.me/5212482660871" target="_blank" class="btn btn-success rounded-pill px-4 shadow-sm w-100">
        ...
        @else
            ...
            <div class="reparaciones-container" style="max-height: 600px; overflow-y: auto; overflow-x: hidden; padding: 10px; margin: -10px;">
