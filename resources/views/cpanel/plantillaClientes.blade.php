    ...
    <nav class="navbar fixed-top navbar-dark shadow-sm" style="background-color: #00a8e8;">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <a class="navbar-brand fw-bold" href="{{route('index')}}">SoluxMovil</a>
            </div>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow">
                    <li><a class="dropdown-item" href="{{route('perfilCliente')}}"><i class="bi bi-person me-2"></i>Mi Perfil</a></li>
                ...
                <div class="offcanvas-body p-0">
                    <ul class="navbar-nav justify-content-end flex-grow-1">
                        <li class="nav-item p-2">
                            <a class="nav-link px-3 py-2 rounded {{ request()->routeIs('index') ? 'active bg-white bg-opacity-10 fw-bold' : '' }}"
                               href="{{route('index')}}">
                        ...
                        <li class="nav-item p-2">
                            <a class="nav-link px-3 py-2 rounded {{ request()->routeIs('Mis-reparaciones.index') ? 'active bg-white bg-opacity-10 fw-bold' : '' }}"
                               href="/cliente/Mis-reparaciones">
                                <i class="bi bi-search me-3 fs-5"></i> Consultar Reparación
                            </a>
                        </li>
