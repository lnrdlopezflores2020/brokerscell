    ...
    <nav class="navbar fixed-top navbar-dark shadow-sm" style="background-color: #00a8e8;">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <a class="navbar-brand fw-bold" href="{{route('inicio.index')}}">SoluxMovil</a>
            </div>
            ...
            <div class="offcanvas offcanvas-start text-white" style="background-color: #007bb5;" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body p-0">
                    <ul class="navbar-nav justify-content-end flex-grow-1">
                        {{-- Nota: Eliminé el padding inline excesivo en los links para que la animación hover se vea mejor --}}

                        <li class="nav-item p-2">
                            <a class="nav-link px-3 py-2 rounded {{ request()->routeIs('inicio.index') ? 'active bg-white bg-opacity-10 fw-bold' : '' }}"
                        ...
                        <li class="nav-item p-2">
                            <a class="nav-link px-3 py-2 rounded {{ request()->routeIs('usuarios.*') ? 'active bg-white bg-opacity-10 fw-bold' : '' }}"
                               href="/admon/usuarios/">
                        ...
                        <li class="nav-item p-2">
                            <a class="nav-link px-3 py-2 rounded {{ request()->routeIs('tecnicos.*') ? 'active bg-white bg-opacity-10 fw-bold' : '' }}"
                               href="/admon/tecnicos/">
                                <i class="bi bi-phone-fill me-3 fs-5"></i> Tecnicos
                            </a>
                        </li>

                        <li class="nav-item p-2">
                            <a class="nav-link px-3 py-2 rounded {{ request()->routeIs('reparaciones.*') ? 'active bg-white bg-opacity-10 fw-bold' : '' }}"
                               href="/admon/reparaciones/">
                                <i class="bi bi-tools me-3 fs-5"></i> Reparaciones
                            </a>
                        </li>

                        <li class="nav-item p-2">
                            <a class="nav-link px-3 py-2 rounded {{ request()->routeIs('admon.respaldos*') ? 'active bg-white bg-opacity-10 fw-bold' : '' }}"
                               href="{{ route('admon.respaldos') }}">
                                <i class="bi bi-database-down me-3 fs-5"></i> Respaldos DB
                            </a>
                        </li>
                    </ul>
                </div>
